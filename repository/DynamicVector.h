//
// Created by leonard on 13.04.2022.
//
#ifndef LAB6_7_DYNAMICVECTOR_H
#define LAB6_7_DYNAMICVECTOR_H
#include <iostream>
#include <exception>
#include <functional>
...
template<typename TElem> void DynamicVector<TElem>::add(const TElem& el) {
    if (lg == cap)
        resize();
